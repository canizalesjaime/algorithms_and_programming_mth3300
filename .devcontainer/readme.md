# Steps for Docker with Dev Containers:
...
3. Make sure that vscode is opened with Mth3300_algorithms_and_programming folder(go to **File** on top left then press **Open Folder...**)
